...
$lang = array(
	...
	'subnets' => "Υποδίκτυα",
	'ip_address_edit' => "Επεξεργασία DNS Εμπρός",
	'ip_address_add' => "Προσθήκη Προώθηση DNS",
	'ip_addresses' => "Προώθηση εγγραφές DNS",
	'ip_address_rev_add' => "Προσθήκη Reverse DNS",
	'ip_addresses_rev' => "Αντίστροφη DNS Records",
	'ip_address_fwdNrev_add' => "Προσθέστε εμπρός και όπισθεν DNS",
	'ip_addresses_fwdNrev' => "Εμπρός και όπισθεν DNS Records",
