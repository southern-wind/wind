...
$lang = array(
	...
	'ip_address_add' => "Προσθέστε τη διεύθυνση IP",
	'ip_addresses' => "Διευθύνσεις IP (μόνο προς τα εμπρός DNS)",
	'ip_address_rev_add' => "Προσθέστε τη διεύθυνση Αντίστροφη IP",
	'ip_addresses_rev' => "Διευθύνσεις IP (μόνο Reverse DNS)",
	'ip_address_fwdNrev_add' => "Προσθέστε Forward & Reverse DNS",
	'ip_addresses_fwdNrev' => "Διευθύνσεις IP (Forward & Reverse DNS)",
	...
	'message' => array(
		...
		'error' => array(
			...
			'email_invalid' => array(
				'title' => "E-mail error",
				'body' => "Παρακαλώ βεβαιωθείτε ότι η διεύθυνση ηλεκτρονικού ταχυδρομείου σας είναι έγκυρη."
			),
